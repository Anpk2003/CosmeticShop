 ...
 * @author Phung An
 */
@WebFilter(filterName="NewFilter", urlPatterns={"/delete", "/update", "/add", "/update.jsp", "/adminaccount.jsp","/addproduct.jsp",
    "/adminproduct.jsp","/manager.jsp","/cart.jsp","/cart","/bill.jsp","/profile.jsp","/profile","/account","/add.jsp"})
