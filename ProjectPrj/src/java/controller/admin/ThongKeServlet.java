...
public class ThongKeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DAOOrders o1 = new DAOOrders();
        int demp=d.CountProduct();
        int demu=a.CountUser();
        int demb=od.CountBill();
        int demH=o1.CountBill();
        request.setAttribute("pro", demp);
        request.setAttribute("acc", demu);
        request.setAttribute("nump", demb);
        request.setAttribute("numb", demH);
